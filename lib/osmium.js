...
exports.Area.prototype.geojson = function() {
    return {
        type: 'MultiPolygon',
...
exports.Reader = function(file) {
    ...
    if (arguments.length == 1) {
        this._reader = new osmium.BasicReader(file);
...
exports.apply = function(target) {
    if (target instanceof osmium.Reader) {
        arguments[0] = target._reader;
        return osmium.apply_.apply(this, arguments);
    }
    return osmium.apply_.apply(this, arguments);
}
