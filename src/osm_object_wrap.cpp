...
namespace node_osmium {
    ...
    void OSMWrappedObject::Initialize(v8::Handle<v8::Object> target) {
    ...
    v8::Handle<v8::Value> OSMWrappedObject::New(const v8::Arguments& info) {
    ...
    v8::Handle<v8::Value> OSMWrappedObject::tags(const v8::Arguments& info) {
        INSTANCE_CHECK(OSMWrappedObject, "Object", "tags");
        return OSMEntityWrap::tags_impl<osmium::OSMObject>(info);
    }

    v8::Handle<v8::Value> OSMWrappedObject::get_id(v8::Local<v8::String> /* property */, const v8::AccessorInfo& info) {
        Nan::HandleScope scope;
        info.GetReturnValue().Set(Nan::New(wrapped(info.This()).id()));
        return;
    }

    v8::Handle<v8::Value> OSMWrappedObject::get_version(v8::Local<v8::String> /* property */, const v8::AccessorInfo& info) {
        Nan::HandleScope scope;
        info.GetReturnValue().Set(Nan::New(wrapped(info.This()).version()));
        return;
    }

    v8::Handle<v8::Value> OSMWrappedObject::get_changeset(v8::Local<v8::String> /* property */, const v8::AccessorInfo& info) {
        Nan::HandleScope scope;
        info.GetReturnValue().Set(Nan::New(wrapped(info.This()).changeset()));
        return;
    }

    v8::Handle<v8::Value> OSMWrappedObject::get_visible(v8::Local<v8::String> /* property */, const v8::AccessorInfo& info) {
        Nan::HandleScope scope;
        info.GetReturnValue().Set(Nan::New(wrapped(info.This()).visible()));
        return;
    }

    v8::Handle<v8::Value> OSMWrappedObject::get_timestamp(v8::Local<v8::String> /* property */, const v8::AccessorInfo& info) {
        Nan::HandleScope scope;
        info.GetReturnValue().Set(Nan::New(uint32_t(wrapped(info.This()).timestamp())));
        return;
    }

    v8::Handle<v8::Value> OSMWrappedObject::get_uid(v8::Local<v8::String> /* property */, const v8::AccessorInfo& info) {
        Nan::HandleScope scope;
        info.GetReturnValue().Set(Nan::New(wrapped(info.This()).uid()));
        return;
    }

    v8::Handle<v8::Value> OSMWrappedObject::get_user(v8::Local<v8::String> /* property */, const v8::AccessorInfo& info) {
        Nan::HandleScope scope;
